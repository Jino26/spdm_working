...
uint8_t libspdm_key_exchange_start_mut_auth(
    ...
    uint8_t* /* req_slot_id */, uint8_t /* session_policy */,
    size_t /* opaque_data_length */, const void* /* opaque_data */,
    bool* /* mandatory_mut_auth */)
{
    /* 0 == no mutual authentication requested. */
    return 0;
}
#endif /* LIBSPDM_ENABLE_CAPABILITY_MUT_AUTH_CAP */
...
uint32_t libspdm_get_cert_chain_slot_storage_size(void* /* spdm_context */,
                                                  uint8_t /* slot_id */)
{
    /* 0 == no storage available; SET_CERTIFICATE is not supported here. */
    return 0;
}
...
bool libspdm_gen_csr(
    ...
    uint8_t* /* req_csr_tracking_tag */, uint8_t /* req_key_pair_id */,
...
bool libspdm_read_key_pair_info(
    ...
    uint8_t* /* total_key_pairs */, uint16_t* /* capabilities */,
